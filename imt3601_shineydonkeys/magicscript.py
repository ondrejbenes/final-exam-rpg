...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "Ai assignment 2"
 
        #Project url
        self.project_url = "http://www.stagediver.co.uk"
 
        #Version of program
        self.project_version = "2016.1.0.3"
 
        #License of the program
        self.license = "MyApps License"
 
        #Auhor of program
        self.author_name = "Hoppemannen"
        self.author_email = "espenvh@gmail.com"
        self.copyright = "Copyright (c) 2016 Espen Haehre"
 
        #Description
        self.project_description = "Game programming asssignment at NTNU 2016"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = "e:\\favicon.ico"
        #None
